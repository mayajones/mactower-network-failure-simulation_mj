...
save.image("AA2012Oct23.RData")
load("AA2012Oct23.RData")
...
summary(lm(lifespan$RLS_Del_alpha ~ lifespan$stddev))
plot(lifespan$RLS_Del_alpha ~ lifespan$stddev)

summary(lm(lifespan$RLS_Del_alpha ~ sqrt(1/lifespan$stddev)))
summary(lm(lifespan$RLS_Del_alpha ~ sqrt(lifespan$stddev)))
